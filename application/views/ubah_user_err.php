        ...
        <div class="row">
          ...
          <div class="card card-info">
              ...
              <form class="form-horizontal" action="<?=base_url('dashboard/doubahuser')?>" method="post">
                <input type="hidden" name="user_id" value="<?=set_value('user_id');?>">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail" placeholder="Email" name="email" value="<?=$username?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role0" value="0"><input class="custom-control-input" type="checkbox" id="checkAdmin" name="role0" value="1" <?php echo set_value('role0') == "1" ? "checked" : ""?>>
                          <label for="checkAdmin" class="custom-control-label">Admin</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role1" value="0"><input class="custom-control-input" type="checkbox" id="checkKur" name="role1" value="1" <?php echo set_value('role1') == "1" ? "checked" : ""?>>
                          <label for="checkKur" class="custom-control-label">Tim Kurikulum</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role2" value="0"><input type="hidden" name="role2" value="0"><input class="custom-control-input" type="checkbox" id="checkMan" name="role2" value="1" <?php echo set_value('role2') == "1" ? "checked" : ""?>>
                          <label for="checkMan" class="custom-control-label">Manajemen Prodi</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role3" value="0"><input class="custom-control-input" type="checkbox" id="checkKoor" name="role3" value="1" <?php echo set_value('role3') == "1" ? "checked" : ""?>>
                          <label for="checkKoor" class="custom-control-label">Dosen Koordinator</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role4" value="0"><input class="custom-control-input" type="checkbox" id="checkPengajar" name="role4" value="1" <?php echo set_value('role4') == "1" ? "checked" : ""?>>
                          <label for="checkPengajar" class="custom-control-label">Dosen Pengajar</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role5" value="0"><input class="custom-control-input" type="checkbox" id="checkPeer" name="role5" value="1" <?php echo set_value('role5') == "1" ? "checked" : ""?>>
                          <label for="checkPeer" class="custom-control-label">Dosen Peer</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input type="hidden" name="role6" value="0"><input class="custom-control-input" type="checkbox" id="checkPDCA" name="role6" value="1" <?php echo set_value('role6') == "1" ? "checked" : ""?>>
