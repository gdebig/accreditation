        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Membuat Tim Kurikulum</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?=base_url('manajemen/docreatetimkur')?>" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info" name="btncreate" value="buat">Buat Tim Kurikulum</button>
